...
type MemberRole = "admin" | "member" | "creator";
...
const MOCK_MEMBERS: Member[] = [
  { id: "1", name: "用户 1937822", avatar: undefined, role: "admin" },
  { id: "2", name: "自信阿德勒", avatar: undefined, role: "member" },
  { id: "3", name: "小橘子_888", avatar: undefined, role: "creator" },
];

const MOCK_APPLICATIONS: Application[] = [
  { id: "a1", name: "用户1937822", avatar: undefined, status: "pending" },
  { id: "a2", name: "自信阿德勒", avatar: undefined, status: "pending" },
  { id: "a3", name: "用户53252352", avatar: undefined, status: "approved" },
];
...
function ApplicationRow({ application }: { application: Application }) {
  ...
  return (
    <div className="flex items-center justify-between gap-3 py-3">
      <div className="flex min-w-0 flex-1 items-center gap-3">
        <ListItemAvatar name={application.name} avatar={application.avatar} />
