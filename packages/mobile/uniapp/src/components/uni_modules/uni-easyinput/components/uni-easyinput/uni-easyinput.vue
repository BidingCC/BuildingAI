 ...
 * @property {String}	primaryColor	设置主题色（默认var(--primary)）
...
export default {
    ...
    computed: {
        ...
        inputStyle() {
            const paddingRight =
                this.type === "password" || this.clearable || this.$slots.prefix ? "" : "10px";
            return obj2strStyle({
                "padding-right": paddingRight,
                "padding-left": this.$slots.prefix ? "" : "10px",
            });
        },
    },
    watch: {
    ...
    <view class="uni-easyinput" :class="{ 'uni-easyinput-error': msg }" :style="boxStyle">
        <view class="uni-easyinput__content" :class="inputContentClass" :style="inputContentStyle">
            ...
            <template v-if="type === 'password' && passwordIcon">
                <view :class="{ 'text-primary': focusShow }" v-if="isVal" @click="onEyes">
                    <view class="mb-[2px]" i-lucide-eye-off v-if="showPassword" />
                    <view class="mb-[2px]" i-lucide-eye v-else />
                </view>
            </template>
