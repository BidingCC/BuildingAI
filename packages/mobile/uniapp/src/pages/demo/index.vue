...
import UniBadge from "@/async-components/uni_modules/uni-badge/components/uni-badge/uni-badge.vue?async";
import UniCountdown from "@/async-components/uni_modules/uni-countdown/components/uni-countdown/uni-countdown.vue?async";
import UniEasyinput from "@/async-components/uni_modules/uni-easyinput/components/uni-easyinput/uni-easyinput.vue?async";
import UniForms from "@/async-components/uni_modules/uni-forms/components/uni-forms/uni-forms.vue?async";
import UniFormsItem from "@/async-components/uni_modules/uni-forms/components/uni-forms-item/uni-forms-item.vue?async";
...
const formData = reactive<UniFormsInstance>({
    name: "",
    age: "",
    hobby: [],
});
