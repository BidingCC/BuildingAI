...
<style lang="scss">
@import "@/async-components/ua-markdown/css/markdown-style.css";
// @import "@/async-components/ua-markdown/lib/highlight/atom-one-dark.css";
// @import "@/async-components/ua-markdown/lib/highlight/atom-one-light.css";
@import "@/async-components/ua-markdown/lib/highlight/github-dark.min.css";
@import "@/async-components/ua-markdown/lib/highlight/snazzy.css";
